...
function bodystatic_iconCopy_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function bodystatic_iconCopy_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { bodystatic_iconCopy_ownKeys(Object(source), true).forEach(function (key) { bodystatic_iconCopy_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { bodystatic_iconCopy_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function bodystatic_iconCopy_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
    ...
    children: icons.map(icon => {
      return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
        ...
        children: [icon.icon && /*#__PURE__*/jsx_runtime_.jsx("div", {
          ...
          children: icon.body
        }), icon.cta && /*#__PURE__*/jsx_runtime_.jsx(button_button/* default */.Z, bodystatic_iconCopy_objectSpread({}, icon.cta))]
      }, icon._key);
    })
  });
};
...
const hero_centertxt = props => {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx("h1", {
        children: heading
      }), tagline.richText ? /*#__PURE__*/jsx_runtime_.jsx(richText_field, {
        className: (hero_centertxt_module_default()).tagline,
        richText: tagline.richText,
        align: tagline.align
      }) : /*#__PURE__*/jsx_runtime_.jsx("h5", {
        children: tagline
      }), cta.title && /*#__PURE__*/jsx_runtime_.jsx(button_button/* default */.Z, hero_centertxt_objectSpread({}, cta))]
    })
  });
};
...
function bodystatic_cardImg_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function bodystatic_cardImg_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { bodystatic_cardImg_ownKeys(Object(source), true).forEach(function (key) { bodystatic_cardImg_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { bodystatic_cardImg_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function bodystatic_cardImg_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
    ...
    children: cards.map((card, i) => {
      return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
        ...
        children: [card.icon && /*#__PURE__*/jsx_runtime_.jsx("div", {
          ...
          children: card.body
        }), card.cta && /*#__PURE__*/jsx_runtime_.jsx(button_button/* default */.Z, bodystatic_cardImg_objectSpread({}, card.cta))]
      }, card._key);
    })
  });
};
...
const bodystatic_galleryGrid = props => {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx("div", {
    className: "bodystatic-galleryGrid umoja-l-grid--6 umoja-l-grid-gap--row-2",
...
const Link = props => {
  ...
  if (linkUrl) {
    return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
      children: link.internalLink ? /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx(next_link__WEBPACK_IMPORTED_MODULE_3__.default, {
        href: `/${linkUrl}`,
